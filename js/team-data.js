  ...
  var members = [
    ...
    },
    {
      ...
      ar: {
        ...
        paras: [
          "هبة أخصائية نفسية إكلينيكية ومعالِجة للصحة النفسية تمارس منذ ست سنوات، إلى جانب خبرة سابقة عبر تدريبات عملية في سياقات متنوعة. تتبنّى نهجًا انتقائيًا يسترشد باحتياجات كل عميل، مع تركيز كبير على أن يشعر العميل بأنه مرئي ومسموع ومتقبَّل في مساحة آمنة خالية من الأحكام.",
